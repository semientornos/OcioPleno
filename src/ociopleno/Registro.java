...
import static ociopleno.Login.getSesion;
...
public class Registro extends javax.swing.JFrame {
    ...
    private boolean validaDatos(){
        ...
        while(cursorCaja.hasNext()){
            ...
            //si la afición está seleccionada pasa al cliente c
     ...
     * @return 
     */
    private boolean creaCliente(String pwd){
        Cliente c;
        // --- HIBERNATE        
        Transaction tx = null;
        ...
        try{
             ...
             // Se obtiene el idc máximo para añadirle 1
             SQLQuery q= sesion.createSQLQuery("SELECT max(idc) FROM cliente cli");
             
             List resultados=q.list();
             if(resultados == null){
                return false;
            }else{
                id = (Integer)resultados.get(0);
                id++;
            }

          //Carga de datos
          c=new Cliente(id);
          c.setNick(C_usuario.getText());
          c.setPass(pwd);

          c.setLugar(C_lugar.getText());
          ...
          if(fechanacimiento){
                if(validaFechaNacimiento()){
                    ...
                    c.setFnacimiento(d.getTime());
                }
          }
          
          if(R_hombre.isSelected())c.setSexo('H');
          else if(R_mujer.isSelected())c.setSexo('M');
        ...
        while(cursorCaja.hasNext()){
            ...
            JCheckBox cajita=(JCheckBox)cursorCaja.next();
            //si la afición está seleccionada pasa al cliente c
            if(cajita.isSelected())c.getAficioneses().add(a);
        }
        //Grabamos el cliente
        ...
        tx.commit();
         ...
         // Si todo ha ido bien crea Cliente, lo almacena y retorna true 
        Login.setCliente(c);
        return true;
    }
    ...
    /**
     * METODO QUE DEVUELVE TRUE SI SE HA ENTRADO LA FECHA DE NACIMIENTO
     */
